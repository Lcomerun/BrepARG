...
- [ ] (2026-08-17 21:24 +08:00) Started the unchanged-chain 100-CAD capacity measurement from the validated seed-3 best VQ-8192 and RVQ checkpoints, reusing the completed same-scale bypass rows. The coordinator must finish both calibration/audit arms and write its paired report before the registered VQ-versus-RVQ decision can be made.
...
- [ ] (completed: capacity training and selector-negative snapshots; remaining: capacity assembly report, final validation, commit, and normal push) Snapshot Git-safe evidence into `reports/capacity_ab_60k_v2_20260817/`, `reports/assembly_selector_invalid16_v3_20260817/`, and the completed capacity-assembly report directory. Validate forbidden-file exclusions, commit, and push normally to `protocol-v5-assembly-selector`.
